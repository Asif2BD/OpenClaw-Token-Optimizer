...
class ReleaseTests(unittest.TestCase):
    def test_version_consistent(self):
        self.assertIn('version: 4.0.2',(ROOT/'SKILL.md').read_text())
        self.assertIn('version-4.0.2-',(ROOT/'README.md').read_text())
        self.assertIn('## v4.0.2',(ROOT/'CHANGELOG.md').read_text())
        self.assertIn('# Version: 4.0.2',(ROOT/'SHA256SUMS.txt').read_text())
